...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_fullsize_ansi_split_spc(
        ...
        RGB_TEST,    KC_LCTL,   KC_LWIN, KC_LALT,          KC_SPC,                             KC_SPC,                    KC_RALT, KC_RWIN, MO(WIN_FN), KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT
    ),
    [WIN_FN] = LAYOUT_fullsize_ansi_split_spc(
        ...
        _______,     _______, _______, _______,          _______,                               _______,                   _______, _______, _______, RM_TOGG,    RM_PREV, RM_SPDD, RM_NEXT,    _______,          _______
    ),
    [MAC_BASE] = LAYOUT_fullsize_ansi_split_spc(
        ...
        _______,     KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,             KC_ENT,                                   KC_P4,   KC_P5,   KC_P6,
        _______,     KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,             KC_RSFT,             KC_UP,               KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        RGB_TEST,    KC_LCTL,   KC_LOPT, KC_LCMD,          KC_SPC,                             KC_SPC,                    KC_RCMD, KC_ROPT, MO(MAC_FN), KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT
    ),
